...
'Module Combos
'    'tablelocations(x,0) = HiByte
'    'tablelocations(x,1) = LoByte
...
'    Const ComboDataStart As Integer = 89048
...
'        Start = 128
'    End Enum
'    Public Sub ReadCombosFromFile(ByVal FileNumber As Integer)
...
'        Next
'        Y = 0
'        For i As Integer = 0 To Math.Max(0, StartTile - 11) - StartTile Step -1
'            If CBool(ComboBytes(i + StartTile) And Combo.Start) Then
'                G.DrawLine(FinishPen, 21, (Y + 11) * TileSize - 2, 21, (Y + 11) * TileSize)
'            End If
'            If CBool(ComboBytes(i + StartTile) And Combo.Doubled) Then
...
'    Public Sub ExtractCombosByTable(ByVal Destination As Byte(,))
'        For i As Integer = 0 To 15
...
'    Public Descriptions As String() = { _
'    "Black", _
'    "Lines", _
'    "Black 2", _
'    "Bricks", _
